/*
=========================================
revisión 0.0.2 02-07-2019, 00:00 VS 2017
=========================================
*/
...
void sparse_fill_c(__global double* elmA, __global int* colA,
	__global int* rowA, __global double* elmL, __global int* colL,
	__global int* rowL, int size_elmA);

void ldlt_sparse_1_c(__global double* elmL, __global int* colL,
	int order, int step);

void ldlt_sparse_2_c(__global double* elmL, __global int* colL,
	__global int* rowL, int order, int step);
...
void ldlt_sparse_5_c(__global double* elmL,
	__global int* colL, __global int* rowL,
	__global double* y, int order, int step,
...
void ldlt_sparse_3_sks(__global double* elmL,
	__global int* idxL, __global double* b, int order,
	int step);

void ldlt_sparse_4_sks(__global double* elmL,
	__global int* idxL, __global double* b, int order);
...
//-------------------------------
__kernel void
ldlt_sparse_c(__global double* elmA, __global int* colA,
	__global int* rowA, __global double* elmL,
	__global int* colL, __global int* rowL, int size_elmA,
